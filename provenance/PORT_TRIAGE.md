...
| **Fig 5f** | 2D + 3D fingerprints, 5-FU & olaparib | `3_PairwiseCorrelations` — **reconstruction** of the published 2-row all-feature strips; the notebook's own clustermaps are a different rendering. Colour scaling unresolved, see `KNOWN_ISSUES.md` |
