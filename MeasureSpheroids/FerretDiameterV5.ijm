...
#@Float(label="Rolling", description="Rolling ball size - substract background", value="7") roll
...
#@Float(label="maximum", description="maximum threshold value", value="100") max
...
//		saveAs(outputDir + File.separator + substring(name, 0, lastIndexOf(name, ".")) + "_FFT.jpeg"); 
		 		 	 
		 		 	 		 	 		 	 
		 // Preprocess the data - Subtract background 
		 run("Subtract Background...", "rolling=roll create disable");
		 waitForUser;
		 ...
		 selectWindow("Drawing of Result of " + name);
