...
#@Float(label="maximum", description="maximum threshold value", value="160") max
...
for (i=0; i<list.length; i++) {
 ...
 if(name.contains("tiff")) {
		 ...
		 run("Calculator Plus", "i1=name i2=nameBlurred operation=[Divide: i2 = (i1/i2) x k1 + k2] k1=K1 k2=0 create");
