...
//#@Float(label="kernIC", description="Kernel size for the illumination correction", value="180") kernIC
#@Float(label="kernTh", description="Kernel size for the threshold preprocessing", value="8") kernTh
#@ String(label = "Threshold method", value = "IsoData") thresMeth
#@Float(label="minimum", description="minumum threshold value", value="35") min
#@Float(label="maximum", description="maximum threshold value", value="165") max
