...
| `fig4_umap_shape.png` | the Jan-13 original Fig 4a-d PDFs beside the regenerated panels. The embeddings reproduce — same cluster layout — even though 4c/4d's printed metrics do not |
